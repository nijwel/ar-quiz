            ...
            <div class="col-lg-10">
                <div class="card profile-card mb-4">
                    <div class="card-body p-4 text-center">
                        ...
                        <p class="text-muted"><span class="badge bg-soft-primary text-primary px-3">
                                #{{ auth()->user()->student_id }}</span></p>
                    </div>
                        ...
                        <div class="card border-0 shadow-sm p-4" style="border-radius: 20px;">
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <p class="fs-5 fw-medium">#{{ auth()->user()->student_id }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
